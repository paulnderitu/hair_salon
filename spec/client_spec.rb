...
describe("#save")do
  it("save a new client")do
    test_client= Client.new({:name => "shiro", :contact => "0726", :stylist_id => 1})
    test_client.save()
...
describe("#==") do
  it("is the same client if has same name, contact and stylist ID")do
    client1 = Client.new({:name => "shiro", :contact => "0726", :stylist_id => 1})
    client2 = Client.new({:name => "shiro", :contact => "0726", :stylist_id => 1})
